  ...
  return (
    <>
      ...
      {data && <>
        ...
        <section className="panel"><div className="panel-head"><h2>Recent incidents</h2><Link href="/incidents" className="button small">View all <ArrowRight size={13} /></Link></div><IncidentTable incidents={data.recent_incidents} /></section>
        <TraceConvergence />
      </>}
    </>
  );
