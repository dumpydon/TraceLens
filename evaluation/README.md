...
summary for the frontend. The evaluator functions accept `outputs` and `reference_outputs`, which
matches the callable shape used by LangSmith offline evaluators.
